...
void ARPGPlayerController::CursorTrace()
{
	...
	/**
	* Line trace from cursor. Serveral scenarios:
	*  A. LastActor is null and ThisActor is null
	*      - Do nothing
	*  B. Last = null and This is valid (Enter)
	*      - Highlight This
	*  C. Last is valid and This = null (Leave)
	*      - Unhighlight Last
	*  D. Both valid, but Last != This
	*      - Unhighlight Last and Highlight This
	*  E. Both valid, and Last = This
...
void ARPGPlayerController::Move(const FInputActionValue& InputActionValue)
{
	...
	const FVector ForwardDirection = FRotationMatrix(YawRotation).GetUnitAxis(EAxis::X); // GetUnitAxis returns a normalized vector
